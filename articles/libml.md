...
e.g. [`get_gini()`](https://stufield.github.io/libml/reference/get_gini.md):
...
performance in [`libml`](https://stufield.github.io/libml/index.md).
Many S3 methods are provided to the S3 generic
`globalr::calc_predictions`,
e.g. [`calc_predictions.glm()`](https://stufield.github.io/libml/reference/s3-calc_predictions.md).
